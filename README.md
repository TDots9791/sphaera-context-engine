...
- **Небольшие модели становятся практичнее.** Им не передаётся неподъёмный архив. Вместо этого они получают короткий путеводитель, ключевые фрагменты и адреса источников. Sphaera не делает слабую модель сильной, но помогает ей не терять нить задачи из-за малого окна контекста.
...
| Контекст | Одна основа данных и адаптивная выдача для разных AI-моделей | Малые модели не тонут в архиве, а большие не тратят контекст на уже известное |
